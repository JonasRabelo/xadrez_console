...
namespace xadrez
{
    class PartidaDeXadrez
    {
        ...
        public void RealizaJogada(Posicao origem, Posicao destino)
        {
            ...
            if (EstaeEmXeque(Adversaria(JogadorAtual)))
            {
                Xeque = true;
            }
            else
        ...
        public bool EstaeEmXeque(Cor cor)
        {
            Peca R = Rei(cor);
            if (R == null)
            {
                ...
                for (int i = 0; i < tab.Linhas; i++)
                {
                    for (int j = 0; j < tab.Colunas; j++)
                    {
                        if (mat[i, j])
                        {
                            ...
                            Peca pecaCapturada = ExecutarMovimento(origem, destino);
                            bool testeXeque = EstaeEmXeque(cor);
                            DesfazMovimento(origem, destino, pecaCapturada);
                            if (!testeXeque)
                            {
                                return false;
        ...
        public void ColocarPecas()
        {
            ...
            {
                ColocarNovaPeca(l, 2, new Peao(tab, Cor.Branca, this));
            }
            ...
            foreach (char l in letras)
            {
                ColocarNovaPeca(l, 7, new Peao(tab, Cor.Preta, this));
            }
